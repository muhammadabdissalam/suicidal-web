<template>
  <div class="relative text-left">
    ...
    <div class="relative h-8 flex justify-center">
      <input
        :id="name"
        :class="
          textFieldVariant({
...
const textFieldVariant = cva(
  'text-black main-14px-400 focus:border-[#0089B7] inline w-full flex border-px rounded-1.5 border-solid bg-white px-3 py-2 no-underline outline-0 disabled:bg-grey-60 disabled:border-grey-40',
  {
    variants: {
      isError: {
